...
setwd("~/xjj/drug/drug_result/durg62")
write.table(RNAseq_result,"RNAseq_result_result_42drug_P0.01.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
ggsave(paste("FDR_",text_freq,"_FC_",text_FC,"_DEGs.pdf",sep=""),p,width = 10, height = 10)
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(Acetylase_result,"DEAcetylase_result_42drug_P0.01.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
foreach(k=1:nrow(tresult_want))%do%{
  ...
  eeu<-keggu@result
  ee1u<-eeu[which(eeu$pvalue<keggfreq),]
  ...
  eed<-keggd@result
  ee1d<-eed[which(eed$pvalue<keggfreq),]
...
colnames(clusterProfiler_result)<-c("drug","KEGG_up_P0.05","KEGG_down_P0.05","GO_up_FDR0.01","GO_down_FDR0.01")
setwd("~/xjj/drug/drug_result/durg62")
write.table(clusterProfiler_result,"RNAseq_clusterProfiler_result_42drug_DEGP0.05_KEGG_P0.05_GO_FDR0.01.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(ATACseq_result,"ATACseq_result_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出

##################   整理表格   #####################
rm(list=ls())
setwd("~/xjj/drug/drug_result")
first_category_name1 = list.files("durg62")  
first_category_name =first_category_name1[-c(2:11,14:19,56,60)]
dir = paste("~/xjj/drug/drug_result/durg62/",first_category_name,sep="")  
n = length(dir) 
library(foreach)
library("data.table")
setwd("~/xjj/drug/drug_result/durg62")
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(ATACseq_Statistics,"ATACseq_result_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(ATAC_pie_result,"ATAC_pie_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(TSS100KB_anno_result,"TSS100KB_anno_result_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
foreach(k=1:nrow(tresult_want))%do%{
  ...
  setwd(paste("~/xjj/drug/drug_result/durg62/",file_name,"/7_CNV",sep=""))
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(ATACseq_CNV,"ATACseq_CNV_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
setwd(paste("~/xjj/drug/drug_result/durg62/",file_name,"/3_intersect/correlation",sep=""))
ggsave(paste("correlation_",file_name,"-0.05-P-pearson.pdf",sep=""),pp,width = 10, height = 4)
ps<-ggplot(data=dat1, aes(x=DEGslog2FC, y=DApeakslog2FC))+geom_point(color="red",size=0.1)+stat_smooth(method="lm",se=FALSE)+stat_cor(data=dat1, method = "spearman")+
  ...
  geom_text_repel(
    ...
    segment.color = "black", show.legend = FALSE )
setwd(paste("~/xjj/drug/drug_result/durg62/",file_name,"/3_intersect/correlation",sep=""))
ggsave(paste("correlation_",file_name,"-0.05-P-spearman.pdf",sep=""),ps,width = 10, height = 4)
#plot(p)
}
#pearson", "kendall", "spearman
colnames(DEGs_corre_DApeaks)<-c("drug","pearson-estimate","pearson-pvalue","spearman-estimate","spearman-pvalue")
setwd("~/xjj/drug/drug_result/durg62")
write.table(DEGs_corre_DApeaks,"DEGs_corre_DApeaks_FC_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
foreach(k=1:nrow(tresult_want))%do%{
  file_name=as.character(tresult_want[k,1])
  cat(file_name,"\n")
setwd(paste("~/xjj/drug/drug_result/durg62/",file_name,"/4_TFs/homer_result/sen-res-",file_name,"-0.05-P-logFC0-DESeq2-up",sep=""))
...
setwd(paste("~/xjj/drug/drug_result/durg62/",file_name,"/4_TFs/homer_result/sen-res-",file_name,"-0.05-P-logFC0-DESeq2-down",sep=""))
knownResults<-read.delim("knownResults.txt",header=T,sep='\t')
FDR05<-knownResults[knownResults$q.value..Benjamini.<freq,]
#FDR05<-knownResults[knownResults$P.value<0.01,]
homer_TF1<-data.frame(lapply(strsplit(as.character(FDR05[,1]),'/'), function(x) x[3])%>%unlist())
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(TFs_result,"DApeaks_TFs_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出
...
setwd("~/xjj/drug/drug_result/durg62")
write.table(DETFs_result,"DETFs_result_42drug.txt",sep = '\t',col.names = T,row.names = F,quote = FALSE)##数据输出

############################  DETFs--DEGs  ############################
rm(list=ls())
setwd("~/xjj/drug/drug_result/durg62")
DETFs<-read.delim("DETFs_result_42drug.txt",header=T,sep='\t')
